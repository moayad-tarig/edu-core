...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <ul class="navbar-nav m-auto">
        ...
        <li class="nav-item ">
            <a class="nav-link {{ sidebarItemActive(['courses.*']) }} " href="{{ route('courses.index') }}">Courses</a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ sidebarItemActive(['about.*']) }}" href="{{ route('about.index') }}">About</a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ sidebarItemActive(['blog.*']) }}" href="{{ route('blog.index') }}">Blogs</a>
        </li>

        <li class="nav-item">
            <a class="nav-link {{ sidebarItemActive(['contact.*']) }}" href="{{ route('contact.index') }}">contact us</a>
        </li>
        @foreach ($customPages as $page)
            <li class="nav-item">
                <a class="nav-link {{ sidebarItemActive(['custom-page.*']) }}" href="{{ route('custom-page', $page->slug) }}">{{ $page->title }}</a>
            </li>
        @endforeach
    </ul>
