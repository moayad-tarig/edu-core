...
<section class="wsus__courses_3 pt_120 xs_pt_100 mt_120 xs_mt_90 pb_120 xs_pb_100">
    ...
    <div class="container">
                    ...
                    <ul class="nav nav-pills justify-content-center" id="pills-tab" role="tablist">
                        @if ($categoryOne)
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="pills-{{ $categoryOne->id }}-tab"
                                    ...
                                    aria-selected="true">{{ $categoryOne->name }} one </button>
                            </li>
                        @endif
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-{{ $categoryTwo->id }}-tab"
                                ...
                                role="tab" aria-controls="pills-home"
                                aria-selected="true">{{ $categoryTwo->name }} two</button>
                        </li>
                    @endif
                    ...
                    @if ($categoryThree)
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-{{ $categoryThree->id }}-tab"
                                ...
                                role="tab" aria-controls="pills-home"
                                aria-selected="true">{{ $categoryThree->name }} three</button>
                        </li>
                    @endif
                    ...
                    @if ($categoryFour)
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-{{ $categoryFour->id }}-tab"
                                ...
                                role="tab" aria-controls="pills-home"
                                aria-selected="true">{{ $categoryFour->name }} four </button>
                        </li>
                    @endif
                    ...
                    @if ($categoryFive)
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-{{ $categoryFive->id }}-tab"
                                ...
                                role="tab" aria-controls="pills-home"
                                aria-selected="true">{{ $categoryFive->name }} five</button>
                        </li>
                    @endif
        ...
        <div class="tab-content" id="pills-tabContent">
            @if($categoryOne)
            <div class="tab-pane fade" id="pills-{{ $categoryOne->id }}" role="tabpanel" aria-labelledby="pills-home-tab"
                tabindex="0">
                <div class="row">
