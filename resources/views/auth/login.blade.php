...
@section('content')
        ...
        SIGN IN START
    ============================-->
    <section class="wsus__sign_in my-5 p-5">
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="wsus__login_form_input">
                                            ...
                                            <input type="text"  id="email" name="email" :value="old('email')" autocomplete="username" placeholder="Email or Username" autofocus required>
                                        </div>
                                        <x-input-error :messages="$errors->get('email')" class="mt-2" />
                                    </div>
                                    <div class="col-xl-12">
